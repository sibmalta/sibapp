...
describe('SellerDropoffPage', () => {
  ...
  it('keeps mobile drop-off cards compact without removing required fields', () => {
    ...
    expect(source).toContain('space-y-1.5 pb-2 sm:space-y-2')
    expect(source).toContain('rounded-lg border p-2 shadow-sm sm:rounded-xl sm:p-3')
    expect(source).toContain('text-sm font-black leading-tight')
    expect(source).toContain('min-h-9')
    expect(source).toContain('mb-2 rounded-lg border border-blue-100 bg-blue-50 p-2')
    expect(source).toContain('rounded-md px-2 py-1 text-[11px] font-black')
