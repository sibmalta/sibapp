...
describe('seller drop-off flow', () => {
  ...
  it('includes the QR drop-off confirmation migration and admin scan route', () => {
    ...
    expect(storeMigration).toContain('p_store_id TEXT DEFAULT NULL')
    expect(storeMigration).toContain('p_store_name TEXT DEFAULT NULL')
    expect(storeMigration).toContain('dropoff_location_name')
    expect(storeMigration).toContain('dropoff_store_id')
    expect(storeMigration).toContain('logistics_delivery_sheet')
    expect(storeMigration).toContain('buyer_surname')
    expect(storeMigration).toContain('buyer_locality')
    expect(storeMigration).toContain('logisticsRowCreated')
    expect(storeMigration).toContain('Europe/Malta')
    expect(storeMigration).toContain('GRANT EXECUTE ON FUNCTION public.confirm_public_dropoff_scan(TEXT, TEXT, TEXT, TEXT, TEXT) TO anon, authenticated')
    ...
    expect(scanPage).toContain('PUBLIC_DROPOFF_STORES')
    expect(scanPage).toContain('Select store')
