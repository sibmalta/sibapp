...
describe('orders loading reliability', () => {
  it('bounds order fetches and always clears loading state', () => {
    ...
    expect(hook).toContain("console.info('[useOrders] orders fetch start'")
    expect(hook).toContain("console.info('[useOrders] orders fetch end'")
  ...
  it('shows an orders error and retry instead of loading forever', () => {
    ...
    expect(page).toContain('We couldn&apos;t load your orders.')
