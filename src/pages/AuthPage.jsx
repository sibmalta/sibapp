    ...
    <div className="min-h-screen bg-sib-warm flex flex-col items-center justify-center px-5">
      <div className="w-full max-w-sm">
        ...
        <div className="text-center mb-8">
          <div className="inline-flex items-center justify-center w-16 h-16 rounded-2xl bg-sib-primary mb-4 shadow-lg shadow-sib-primary/30">
            <span className="text-white font-black text-2xl tracking-tight">Sib</span>
          </div>
