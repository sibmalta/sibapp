            ...
            <div className="mt-4 space-y-3">
              <label className="flex items-start gap-2.5 cursor-pointer">
                ...
                <span className="text-xs text-sib-muted leading-relaxed">
                  I agree to the <Link to="/terms" className="text-sib-secondary font-semibold underline underline-offset-2">Terms & Conditions</Link> and <Link to="/privacy" className="text-sib-secondary font-semibold underline underline-offset-2">Privacy Policy</Link>
                </span>
              </label>
