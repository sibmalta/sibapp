...
import {
  ...
  ChevronRight, ShieldCheck, Banknote, Calendar,
} from 'lucide-react'
        ...
        {filteredSales.map(order => {
          ...
          return (
            <div
              ...
              className="p-3 rounded-2xl border border-sib-stone flex items-center gap-3 cursor-pointer active:bg-sib-sand transition-colors"
            >
              <img
