...
export default function OrdersPage() {
  const { currentUser, getUserOrders, getUserSales, getListingById, getUserById } = useApp()
      ...
      {displayed.length === 0 ? (
        <div className="flex flex-col items-center justify-center py-20 gap-3">
          ...
          {tab === 'buying' ? (
            ...
            <button onClick={() => navigate('/sell')} className="mt-2 bg-sib-secondary text-white px-5 py-2.5 rounded-full text-sm font-semibold">List Item</button>
          )}
        </div>
      ) : (
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <div className="flex items-center justify-between mt-2">
                    ...
                    <span className="text-sm font-bold text-sib-primary">€{order.totalPrice}</span>
                  </div>
                </div>
              </div>
            )
