    ...
    <form onSubmit={handleSubmit}>
      ...
      <div className="mb-4">
        <ExpressCheckoutElement
          ...
          onLoadError={(event) => {
            console.error('Bundle ExpressCheckoutElement load error:', event)
          ...
          <div className="lg:flex-1">
            ...
            <div className="mb-5 space-y-3">
                ...
                <div className="flex gap-3">
                  ...
                  <div className="flex-1">
                    <div className={`flex border rounded-xl overflow-hidden bg-white dark:bg-[#26322f] ${errors.phone ? 'border-red-400' : 'border-sib-stone dark:border-[rgba(242,238,231,0.10)]'} focus-within:border-sib-primary focus-within:ring-1 focus-within:ring-sib-primary/20`}>
                      <select
                ...
                <div>
                  <input value={address} onChange={e => { setAddress(e.target.value); clearErr('address'); setAddressConfirmed(false); setClientSecret(null) }} placeholder="Street address" disabled={addressConfirmed}
                    className={`w-full border rounded-xl px-4 py-3 text-sm outline-none text-sib-text dark:text-[#f4efe7] placeholder-sib-muted dark:placeholder:text-[#aeb8b4] bg-white dark:bg-[#26322f] ${errors.address ? 'border-red-400' : 'border-sib-stone dark:border-[rgba(242,238,231,0.10)]'} focus:border-sib-primary focus:ring-1 focus:ring-sib-primary/20 disabled:bg-sib-sand dark:disabled:bg-[#26322f] disabled:opacity-70`} />
                ...
                <div className="flex gap-3">
                  <div className="flex-1">
                    <input value={city} onChange={e => { setCity(e.target.value); clearErr('city'); setAddressConfirmed(false); setClientSecret(null) }} placeholder="City / Town" disabled={addressConfirmed}
                      className={`w-full border rounded-xl px-4 py-3 text-sm outline-none text-sib-text dark:text-[#f4efe7] placeholder-sib-muted dark:placeholder:text-[#aeb8b4] bg-white dark:bg-[#26322f] ${errors.city ? 'border-red-400' : 'border-sib-stone dark:border-[rgba(242,238,231,0.10)]'} focus:border-sib-primary focus:ring-1 focus:ring-sib-primary/20 disabled:bg-sib-sand dark:disabled:bg-[#26322f] disabled:opacity-70`} />
                  ...
                  <div className="w-28">
                    <input value={postcode} onChange={e => { setPostcode(e.target.value.toUpperCase()); clearErr('postcode'); setAddressConfirmed(false); setClientSecret(null) }} placeholder="Postcode" maxLength={8} disabled={addressConfirmed}
                      className={`w-full border rounded-xl px-4 py-3 text-sm outline-none text-sib-text dark:text-[#f4efe7] placeholder-sib-muted dark:placeholder:text-[#aeb8b4] bg-white dark:bg-[#26322f] ${errors.postcode ? 'border-red-400' : 'border-sib-stone dark:border-[rgba(242,238,231,0.10)]'} focus:border-sib-primary focus:ring-1 focus:ring-sib-primary/20 disabled:bg-sib-sand dark:disabled:bg-[#26322f] disabled:opacity-70`} />
