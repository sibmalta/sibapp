              ...
              <div className="flex items-center gap-0.5">
                {[1, 2, 3, 4, 5].map(i => (
                  <Star
                    key={i}
                    size={14}
                    className={i <= Math.round(avgRating) ? 'text-sib-primary fill-sib-primary' : 'text-sib-stone'}
                  />
                ))}
              </div>
              <span className="text-sm font-bold text-sib-text">{avgRating.toFixed(1)}</span>
