  ...
  return (
    <>
      ...
      <div className="fixed inset-x-0 bottom-0 z-50 lg:inset-0 lg:flex lg:items-center lg:justify-center pointer-events-none">
        <div className="pointer-events-auto flex flex-col bg-white rounded-t-2xl lg:rounded-2xl shadow-2xl animate-sheet-up lg:animate-none max-h-[85vh] lg:max-h-[80vh] lg:w-[460px] lg:max-w-[90vw]">
          {/* Handle (mobile only) + header */}
          <div className="pt-2 pb-0 lg:pt-0">
            <div className="w-10 h-1 rounded-full bg-gray-300 mx-auto mb-2 lg:hidden" />
          ...
          <div className="flex-1 min-h-0 overflow-y-auto px-5 py-4 space-y-5">
            {/* Sort */}
            <section>
              <h3 className="text-[11px] font-bold text-gray-400 uppercase tracking-wider mb-2.5 flex items-center gap-1.5">
          ...
          {/* Footer — sticky CTA */}
          <div className="px-5 py-3.5 border-t border-gray-100 safe-area-bottom">
            <button
              onClick={onClose}
