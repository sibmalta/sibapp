...
const POPULAR_BRANDS = [
  'Zara', 'H&M', 'Nike', 'Adidas', 'Mango', 'Levi\'s', 'Ralph Lauren',
  'Tommy Hilfiger', 'Gucci', 'Prada', 'Uniqlo', 'Pull & Bear',
  'Massimo Dutti', 'Calvin Klein', 'Vintage', 'Wrangler', 'Converse',
  'New Balance', 'ASOS', 'Stradivarius',
]
