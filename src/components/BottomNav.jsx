  ...
  return (
    <nav className="fixed bottom-0 left-1/2 -translate-x-1/2 w-full max-w-md z-40 safe-area-bottom">
      ...
      <div className="absolute left-1/2 -translate-x-1/2 -top-6 z-50 flex flex-col items-center">
        ...
        >
          <div className="w-[56px] h-[56px] rounded-full bg-gradient-to-br from-sib-secondary to-sib-primary flex items-center justify-center shadow-lg shadow-sib-secondary/25 ring-[3.5px] ring-white transition-all duration-200 active:scale-90 group-hover:scale-105 group-hover:shadow-xl group-hover:shadow-sib-secondary/30">
