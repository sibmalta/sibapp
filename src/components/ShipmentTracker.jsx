...
import {
  Clock, Package, Truck, MapPin, CheckCircle, XCircle, RotateCcw,
} from 'lucide-react'

const SHIPMENT_STEPS = [
  { key: 'awaiting_shipment', label: 'Awaiting shipment', icon: Clock },
...
export const SHIPMENT_STATUS_CONFIG = {
  awaiting_shipment: { label: 'Awaiting shipment', color: 'bg-yellow-50 text-yellow-700', dotColor: 'bg-yellow-500' },
  shipped: { label: 'Shipped', color: 'bg-blue-50 text-blue-700', dotColor: 'bg-blue-500' },
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="space-y-2">
        ...
        {/* Ship-by deadline for awaiting_shipment */}
        ...
        <div>
          <p className={`text-xs font-semibold ${
            ...
            {isOverdue
              ...
              : `Ship by ${new Date(deadline).toLocaleDateString('en-MT', { weekday: 'short', day: 'numeric', month: 'short' })}`
            }
          </p>
