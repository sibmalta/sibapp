          ...
          <div className="flex-1 max-w-md mx-8">
            <form onSubmit={handleSearch} className="relative">
              ...
              <input
                ...
                className="w-full bg-sib-sand rounded-xl pl-10 pr-9 py-2.5 text-sm text-sib-text placeholder-sib-muted outline-none focus:ring-2 focus:ring-sib-primary/20 transition-shadow"
              />
              {query && (
                <button
                  type="button"
