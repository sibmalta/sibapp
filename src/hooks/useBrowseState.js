...
export default function useBrowseState(defaults = {}) {
  ...
  useEffect(() => {
    saveState({ query, category, conditions, sizes, maxPrice, sort, showFilters, colors, brands, quickFilter })
  }, [query, category, conditions, sizes, maxPrice, sort, showFilters, colors, brands, quickFilter])
