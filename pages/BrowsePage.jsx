...
export default function BrowsePage() {
  ...
  const activeChips = useMemo(() => {
    ...
    return chips
  }, [conditions, sizes, colors, brands, maxPrice, styleTag, genderFilter, sportDetail, activeSportDetailLabel, sportAttributes, category])
              ...
              <SearchAutocomplete
                ...
                onSelect={(suggestion) => {
                  if (suggestion.type === 'item' && suggestion.id) {
                    ...
                    // Apply structured filters directly instead of just setting text
        ...
        <div className="flex-1 px-2.5 pt-1.5 pb-24 lg:px-0 lg:pt-0 lg:pb-6">
          ...
          {results.length === 0 ? (
            <div className="text-center py-14">
              ...
              <p className="text-base font-bold text-sib-text">
                No items found
              </p>
              <p className="text-[13px] text-gray-500 mt-1 max-w-[260px] mx-auto leading-snug">
                {activeFilterCount > 0 || quickFilter || query
              ...
              <div className="flex items-center justify-center flex-wrap gap-2 mt-4">
                ...
                <button
                  ...
                  className="flex items-center gap-1.5 px-4 py-2 text-[13px] font-semibold text-sib-primary bg-white border border-sib-primary/30 rounded-full hover:bg-sib-primary/5 transition-colors"
                >
                  <Plus size={14} />
                  List an item
                </button>
